						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-md btn-outline-success edit_plan" type="button"
											data-id="<?php echo $row['id'] ?>" data-plan="<?php echo $row['plan'] ?>"
											data-description="<?php echo $row['description'] ?>"
											data-amount="<?php echo $row['amount'] ?>">Edit</button>
										<button class="btn btn-md btn-outline-danger delete_plan" type="button"
