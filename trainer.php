						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-12">
									...
									<button class="btn btn-md btn-secondary col-sm-3" type="button" onclick="_reset()">
										Cancel</button>
								</div>
							</div>
						</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p><i class="fa fa-user"></i> <b>
												<?php echo $row['name'] ?>
											</b></p>
										<p><small><i class="fa fa-at"></i> <b>
													<?php echo $row['email'] ?>
												</b></small></p>
										<p><small><i class="fa fa-phone-square-alt"></i> <b>
													<?php echo $row['contact'] ?>
												</b></small></p>
										<p><small><i class="fa fa-money-bill"></i> <b>
													<?php echo number_format($row['rate'], 2) ?>
												</b></small></p>

									</td>
									<td class="text-center">
										<button class="btn btn-md btn-outline-success edit_trainer" type="button"
										...
										<button class="btn btn-md btn-outline-danger delete_trainer" type="button"
