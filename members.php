				...
				<div class="card">
					<div class="card-header">
						...
						<span class="">
							...
							<button class="btn btn-success btn-block btn-sm col-sm-2 float-right" type="button"
								id="new_member">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-success view_member" type="button"
											data-id="<?php echo $row['id'] ?>">View</button>
										<button class="btn btn-sm btn-outline-primary edit_member" type="button"
